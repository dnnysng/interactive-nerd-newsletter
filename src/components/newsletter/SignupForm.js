            ...
            validationSchema={
                step === 1
                    ? Yup.object({
                          ...
                          acceptedTerms: Yup.boolean().required("Required").oneOf([true], "Must accept terms!"),
                      })
                    : Yup.object({
                ...
                {step === 1 && (
                    <>
                        ...
                        <Checkbox name="acceptedTerms">
                            I agree to recieve information from Interactive Nerd in accordance with the following
                            privacy policy.
                        </Checkbox>
                    </>
                )}
